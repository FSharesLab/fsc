...
#include <fscio/wallet_plugin/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key FSC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( fscio::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( fscio::wallet::plain_keys, (checksum)(keys) )
