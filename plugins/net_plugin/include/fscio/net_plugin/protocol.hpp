...
FC_REFLECT( fscio::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( fscio::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( fscio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( fscio::go_away_message, (reason)(node_id) )
FC_REFLECT( fscio::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( fscio::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( fscio::request_message, (req_trx)(req_blocks) )
FC_REFLECT( fscio::sync_request_message, (start_block)(end_block) )
