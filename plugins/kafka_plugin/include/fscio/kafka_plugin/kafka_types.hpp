...
namespace fscio {
    using std::string;
    using fscio::chain::block_header_state;
...
FC_REFLECT(fscio::kafka_block_accept_st, (current_block_num)(current_block_id)(current_block_header)(irreversible_block_num)(irreversible_block_id))
