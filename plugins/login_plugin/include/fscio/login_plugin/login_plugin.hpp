...
FC_REFLECT(fscio::login_plugin::start_login_request_params, (expiration_time))
FC_REFLECT(fscio::login_plugin::start_login_request_results, (server_ephemeral_pub_key))
FC_REFLECT(fscio::login_plugin::finalize_login_request_params,
           (server_ephemeral_pub_key)(client_ephemeral_pub_key)(permission)(data)(signatures))
FC_REFLECT(fscio::login_plugin::finalize_login_request_results, (digest)(recovered_keys)(permission_satisfied)(error))

FC_REFLECT_EMPTY(fscio::login_plugin::do_not_use_gen_r1_key_params)
FC_REFLECT(fscio::login_plugin::do_not_use_gen_r1_key_results, (pub_key)(priv_key))
FC_REFLECT(fscio::login_plugin::do_not_use_sign_params, (priv_key)(data))
FC_REFLECT(fscio::login_plugin::do_not_use_sign_results, (sig))
FC_REFLECT(fscio::login_plugin::do_not_use_get_secret_params, (pub_key)(priv_key))
FC_REFLECT(fscio::login_plugin::do_not_use_get_secret_results, (secret))
