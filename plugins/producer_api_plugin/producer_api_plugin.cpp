 ...
 */
#include <fscio/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(fscio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     fscio::detail::producer_api_plugin_response result{"ok"};
