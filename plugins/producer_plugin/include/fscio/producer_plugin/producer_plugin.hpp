...
#include <fscio/http_client_plugin/http_client_plugin.hpp>
...
FC_REFLECT(fscio::producer_plugin::runtime_options, (max_transaction_time)(max_irreversible_block_age)(produce_time_offset_us)(last_block_time_offset_us)(subjective_cpu_leeway_us)(incoming_defer_ratio));
FC_REFLECT(fscio::producer_plugin::greylist_params, (accounts));
FC_REFLECT(fscio::producer_plugin::whitelist_blacklist, (actor_whitelist)(actor_blacklist)(contract_whitelist)(contract_blacklist)(action_blacklist)(key_blacklist) )
FC_REFLECT(fscio::producer_plugin::integrity_hash_information, (head_block_id)(integrity_hash))
FC_REFLECT(fscio::producer_plugin::snapshot_information, (head_block_id)(snapshot_name))
