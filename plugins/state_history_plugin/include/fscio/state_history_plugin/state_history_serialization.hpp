...
#include <fscio/chain/account_object.hpp>
#include <fscio/chain/controller.hpp>
#include <fscio/chain/exceptions.hpp>
#include <fscio/chain/generated_transaction_object.hpp>
#include <fscio/chain/global_property_object.hpp>
#include <fscio/chain/permission_link_object.hpp>
#include <fscio/chain/permission_object.hpp>
#include <fscio/chain/resource_limits.hpp>
#include <fscio/chain/resource_limits_private.hpp>
#include <fscio/chain/trace.hpp>
#include <fscio/chain_plugin/chain_plugin.hpp>
#include <fscio/state_history_plugin/state_history_plugin.hpp>
...
datastream<ST>& history_serialize_container(datastream<ST>& ds, const chainbase::database& db,
   ...
   fc::raw::pack(ds, unsigned_int(v.size()));
   for (auto& x : v) {
      FSC_ASSERT(!!x, fscio::chain::plugin_exception, "null inside container");
      ds << make_history_serial_wrapper(db, *x);
   }
   return ds;
}
...
void history_pack_big_bytes(datastream<ST>& ds, const fscio::chain::bytes& v) {
...
template <typename ST>
void history_pack_big_bytes(datastream<ST>& ds, const fc::optional<fscio::chain::bytes>& v) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::account_object>& obj) {
   ...
   fc::raw::pack(ds, as_type<fscio::chain::digest_type>(obj.obj.code_version));
   fc::raw::pack(ds, as_type<fscio::chain::block_timestamp_type>(obj.obj.creation_date));
   fc::raw::pack(ds, as_type<fscio::chain::shared_string>(obj.obj.code));
   fc::raw::pack(ds, as_type<fscio::chain::shared_string>(obj.obj.abi));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::table_id_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
operator<<(datastream<ST>&                                                                                     ds,
           const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::key_value_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<fscio::chain::shared_string>(obj.obj.value));
   return ds;
}
...
template <typename ST>
void serialize_secondary_index_data(datastream<ST>& ds, const fscio::chain::key256_t& obj) {
...
template <typename ST, typename T>
datastream<ST>& serialize_secondary_index(datastream<ST>& ds, const fscio::chain::table_id_object& context,
                                          const T& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                   ds,
           const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::index64_object>& obj) {
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                    ds,
           const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::index128_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                    ds,
           const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::index256_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                        ds,
           const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::index_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>& operator<<(
    datastream<ST>&                                                                                             ds,
    const history_context_wrapper<const fscio::chain::table_id_object, fscio::chain::index_long_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::producer_key>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.producer_name.value));
   fc::raw::pack(ds, as_type<fscio::chain::public_key_type>(obj.obj.block_signing_key));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                            ds,
                           const history_serial_wrapper<fscio::chain::shared_producer_schedule_type>& obj) {
   fc::raw::pack(ds, as_type<uint32_t>(obj.obj.version));
   history_serialize_container(ds, obj.db,
                               as_type<fscio::chain::shared_vector<fscio::chain::producer_key>>(obj.obj.producers));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::chain_config>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<fscio::chain::global_property_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<optional<fscio::chain::block_num_type>>(obj.obj.proposed_schedule_block_num));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<fscio::chain::shared_producer_schedule_type>(obj.obj.proposed_schedule)));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::chain_config>(obj.obj.configuration)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                           ds,
                           const history_serial_wrapper<fscio::chain::generated_transaction_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.sender.value));
   fc::raw::pack(ds, as_type<__uint128_t>(obj.obj.sender_id));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<fscio::chain::transaction_id_type>(obj.obj.trx_id));
   fc::raw::pack(ds, as_type<fscio::chain::shared_string>(obj.obj.packed_trx));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::key_weight>& obj) {
   fc::raw::pack(ds, as_type<fscio::chain::public_key_type>(obj.obj.key));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::permission_level>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                      ds,
                           const history_serial_wrapper<fscio::chain::permission_level_weight>& obj) {
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::permission_level>(obj.obj.permission)));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::wait_weight>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::shared_authority>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::permission_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   if (obj.obj.parent._id) {
      auto&       index  = obj.db.get_index<fscio::chain::permission_index>();
      const auto* parent = index.find(obj.obj.parent);
      if (!parent) {
         auto& undo = index.stack().back();
         auto  it   = undo.removed_values.find(obj.obj.parent);
         FSC_ASSERT(it != undo.removed_values.end(), fscio::chain::plugin_exception,
   ...
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::shared_authority>(obj.obj.auth)));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<fscio::chain::permission_link_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                      ds,
                           const history_serial_wrapper<fscio::chain::resource_limits::resource_limits_object>& obj) {
   FSC_ASSERT(!obj.obj.pending, fscio::chain::plugin_exception,
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                 ds,
                           const history_serial_wrapper<fscio::chain::resource_limits::usage_accumulator>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                     ds,
                           const history_serial_wrapper<fscio::chain::resource_limits::resource_usage_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<fscio::chain::resource_limits::usage_accumulator>(obj.obj.net_usage)));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<fscio::chain::resource_limits::usage_accumulator>(obj.obj.cpu_usage)));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                            ds,
           const history_serial_wrapper<fscio::chain::resource_limits::resource_limits_state_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::resource_limits::usage_accumulator>(
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<fscio::chain::resource_limits::ratio>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                        ds,
                           const history_serial_wrapper<fscio::chain::resource_limits::elastic_limit_parameters>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::resource_limits::ratio>(obj.obj.contract_rate)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::resource_limits::ratio>(obj.obj.expand_rate)));
   return ds;
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                             ds,
           const history_serial_wrapper<fscio::chain::resource_limits::resource_limits_config_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<fscio::chain::resource_limits::elastic_limit_parameters>(obj.obj.cpu_limit_parameters)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<fscio::chain::resource_limits::elastic_limit_parameters>(obj.obj.net_limit_parameters)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::action>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   history_serialize_container(ds, obj.db, as_type<std::vector<fscio::chain::permission_level>>(obj.obj.authorization));
   fc::raw::pack(ds, as_type<fscio::bytes>(obj.obj.data));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::action_receipt>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.value));
   fc::raw::pack(ds, as_type<fscio::chain::digest_type>(obj.obj.act_digest));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.global_sequence));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.recv_sequence));
   history_serialize_container(ds, obj.db, as_type<flat_map<fscio::name, uint64_t>>(obj.obj.auth_sequence));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::account_delta>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::action_trace>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::action_receipt>(obj.obj.receipt)));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<fscio::chain::action>(obj.obj.act)));
   ...
   history_serialize_container(ds, obj.db, as_type<flat_set<fscio::chain::account_delta>>(obj.obj.account_ram_deltas));
   ...
   history_serialize_container(ds, obj.db, as_type<std::vector<fscio::chain::action_trace>>(obj.obj.inline_traces));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                          ds,
                           const history_context_wrapper<uint8_t, fscio::chain::transaction_trace>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<fscio::chain::transaction_id_type>(obj.obj.id));
   if (obj.obj.receipt) {
      if (obj.obj.failed_dtrx_trace &&
          obj.obj.receipt->status.value == fscio::chain::transaction_receipt_header::soft_fail)
         fc::raw::pack(ds, uint8_t(fscio::chain::transaction_receipt_header::executed));
      else
   ...
   history_serialize_container(ds, obj.db, as_type<std::vector<fscio::chain::action_trace>>(obj.obj.action_traces));
   ...
   if (obj.obj.failed_dtrx_trace) {
      uint8_t stat = fscio::chain::transaction_receipt_header::hard_fail;
      if (obj.obj.receipt && obj.obj.receipt->status.value == fscio::chain::transaction_receipt_header::soft_fail)
         stat = fscio::chain::transaction_receipt_header::soft_fail;
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<fscio::chain::transaction_trace>& obj) {
   uint8_t stat = fscio::chain::transaction_receipt_header::hard_fail;
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const fscio::get_blocks_result_v0& obj) {
