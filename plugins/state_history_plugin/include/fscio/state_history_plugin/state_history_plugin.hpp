...
// clang-format off
FC_REFLECT(fscio::table_delta, (struct_version)(name)(rows));
FC_REFLECT(fscio::block_position, (block_num)(block_id));
FC_REFLECT_EMPTY(fscio::get_status_request_v0);
FC_REFLECT(fscio::get_status_result_v0, (head)(last_irreversible)(trace_begin_block)(trace_end_block)(chain_state_begin_block)(chain_state_end_block));
FC_REFLECT(fscio::get_blocks_request_v0, (start_block_num)(end_block_num)(max_messages_in_flight)(have_positions)(irreversible_only)(fetch_block)(fetch_traces)(fetch_deltas));
FC_REFLECT(fscio::get_blocks_ack_request_v0, (num_messages));
// clang-format on
