...
CHAINBASE_SET_INDEX_TYPE( fscio::public_key_history_object, fscio::public_key_history_multi_index )

FC_REFLECT( fscio::public_key_history_object, (public_key)(name)(permission) )
