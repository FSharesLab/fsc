...
CHAINBASE_SET_INDEX_TYPE( fscio::account_control_history_object, fscio::account_control_history_multi_index )

FC_REFLECT( fscio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
