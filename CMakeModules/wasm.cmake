...
macro(add_wast_executable)
  ...
  add_custom_command(OUTPUT ${DESTINATION_FOLDER}/${target}.wast
    DEPENDS ${target}.s
    COMMAND $<TARGET_FILE:fscio-s2wasm> -o ${DESTINATION_FOLDER}/${target}.wast -s 10240 ${MAX_MEMORY_PARAM} ${target}.s
  ...
  add_custom_command(OUTPUT ${DESTINATION_FOLDER}/${target}.wasm
    DEPENDS ${target}.wast
    COMMAND $<TARGET_FILE:fscio-wast2wasm> ${DESTINATION_FOLDER}/${target}.wast ${DESTINATION_FOLDER}/${target}.wasm -n
