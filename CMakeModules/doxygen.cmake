configure_file("fsc.doxygen.in" "${CMAKE_BINARY_DIR}/fsc.doxygen")
...
if(NOT DOXYGEN_FOUND)
  ...
  set(DOXY_FSC_VERSION "${VERSION_FULL}" CACHE INTERNAL "Version string used in PROJECT_NUMBER.")
  ...
  if(BUILD_DOXYGEN)
    ...
    add_custom_target(contract_documentation ALL
      COMMAND "${DOXYGEN_EXECUTABLE}" "${CMAKE_BINARY_DIR}/fsc.doxygen"
