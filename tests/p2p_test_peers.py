...
class P2PTestPeers:
    ...
    ports = [8888] # fsciod listening port of each host
    ...
    #ports = [8888, 8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888,8888, 8888] # fsciod listening port of each host
