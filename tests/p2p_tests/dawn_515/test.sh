...
read -d '' genesis << EOF
{
  ...
  "initial_key": "FSC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
plugin = fscio::net_plugin
plugin = fscio::history_api_plugin
http-server-address = 127.0.0.1:8888
blocks-dir = blocks
p2p-listen-endpoint = 0.0.0.0:9876
allowed-connection = any
private-key = ['FSC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV','5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3']
...
programs/fscio-launcher/fscio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clfsc/clfsc -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clfsc/clfsc -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clfsc/clfsc -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
