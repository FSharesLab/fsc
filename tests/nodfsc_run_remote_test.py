...
###############################################################
# nodfsc_run_remote_test
#  Tests remote capability of the nodfsc_run_test. Test will setup cluster and pass nodes info to nodfsc_run_test. E.g.
#  nodfsc_run_remote_test.py -v --clean-run --dump-error-detail
###############################################################
...
pnodes=1
total_nodes=pnodes
actualTest="tests/nodfsc_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("nodfsc", actualTest))
    Print("cmd: %s\n" % (cmd))
