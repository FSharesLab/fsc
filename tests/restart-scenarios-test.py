...
# --kill-count <nodfsc instances to kill>
...
try:
    ...
    Print("Stand up FSC wallet kfscd")
    accountsCount=total_nodes
    walletName="MyWallet"
    Print("Creating wallet %s if one doesn't already exist." % walletName)
    wallet=walletMgr.create(walletName, [cluster.fscioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    fscioAccount=cluster.fscioAccount
    ...
    if not cluster.createAccounts(fscioAccount):
    ...
    Print("nodfsc instances relaunched.")
