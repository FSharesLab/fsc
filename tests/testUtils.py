...
class Utils:
    ...
    FscClientPath="programs/clfsc/clfsc"
    MiscFscClientArgs="--no-auto-kfscd"

    FscWalletName="kfscd"
    FscWalletPath="programs/kfscd/"+ FscWalletName

    FscServerName="nodfsc"
    FscServerPath="programs/nodfsc/"+ FscServerName

    FscLauncherPath="programs/fscio-launcher/fscio-launcher"
    MongoPath="mongo"
    ShuttingDown=False
    CheckOutputDeque=deque(maxlen=10)

    FscBlockLogPath="programs/fscio-blocklog/fscio-blocklog"
