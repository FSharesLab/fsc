...
void blocklog::read_log() {
   ...
   FSC_ASSERT( end, block_log_exception, "No blocks found in block log" );
   FSC_ASSERT( end->block_num() > 1, block_log_exception, "Only one block found in block log" );
...
int main(int argc, char** argv)
{
   ...
   options_description cli ("fscio-blocklog command line options");
   try {
      blocklog blog;
