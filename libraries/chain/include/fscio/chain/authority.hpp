...
FC_REFLECT(fscio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(fscio::chain::key_weight, (key)(weight) )
FC_REFLECT(fscio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(fscio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(fscio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
