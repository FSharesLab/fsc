...
FC_REFLECT( fscio::chain::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( fscio::chain::producer_schedule_type, (version)(producers) )
FC_REFLECT( fscio::chain::shared_producer_schedule_type, (version)(producers) )
