...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::generated_transaction_object, fscio::chain::generated_transaction_multi_index)

FC_REFLECT(fscio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))