...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::transaction_object, fscio::chain::transaction_multi_index)

FC_REFLECT(fscio::chain::transaction_object, (expiration)(trx_id))
