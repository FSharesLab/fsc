...
using action_name    = fscio::chain::action_name;
...
FC_REFLECT( fscio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( fscio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( fscio::chain::setabi                           , (account)(abi) )
FC_REFLECT( fscio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( fscio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( fscio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( fscio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( fscio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( fscio::chain::onerror                          , (sender_id)(sent_trx) )
