...
#include <fscio/chain/action_receipt.hpp>
...
FC_REFLECT( fscio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( fscio::chain::base_action_trace,
                    (receipt)(act)(context_free)(elapsed)(console)(trx_id)
                    (block_num)(block_time)(producer_block_id)(account_ram_deltas)(except) )

FC_REFLECT_DERIVED( fscio::chain::action_trace,
                    (fscio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( fscio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
