...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::permission_link_object, fscio::chain::permission_link_index)

FC_REFLECT(fscio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
