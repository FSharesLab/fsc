...
namespace fscio { namespace chain {
   ...
   namespace webassembly { namespace common {
      ...
      try {
         ...
         if(validating && mod_name != "env")
            FSC_ASSERT( false, wasm_exception, "importing from module that is not 'env': ${module}.${export}", ("module",mod_name)("export",export_name) );
         ...
         FSC_ASSERT( false, wasm_exception, "${module}.${export} unresolveable", ("module",mod_name)("export",export_name) );
         return false;
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against FSCIO specific constraints
      ...
      private:
         ...
         friend class fscio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( fscio::chain::wasm_interface::vm_type, (wavm)(wabt) )
