...
#include <fscio/chain/action.hpp>
#include <numeric>
...
FC_REFLECT( fscio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( fscio::chain::transaction, (fscio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( fscio::chain::signed_transaction, (fscio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( fscio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( fscio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( fscio::chain::deferred_transaction, (fscio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( fscio::chain::deferred_reference, (sender)(sender_id) )
