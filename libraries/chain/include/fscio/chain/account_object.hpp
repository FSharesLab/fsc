...
namespace fscio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const fscio::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      fscio::chain::abi_def get_abi()const {
         fscio::chain::abi_def a;
         FSC_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::account_object, fscio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::account_sequence_object, fscio::chain::account_sequence_index)


FC_REFLECT(fscio::chain::account_object, (name)(vm_type)(vm_version)(privileged)(last_code_update)(code_version)(creation_date)(code)(abi))
FC_REFLECT(fscio::chain::account_sequence_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence))