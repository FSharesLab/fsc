...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::producer_object, fscio::chain::producer_multi_index)

FC_REFLECT(fscio::chain::producer_object::id_type, (_id))
FC_REFLECT(fscio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
