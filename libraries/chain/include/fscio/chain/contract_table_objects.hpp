...
#include <fscio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::table_id_object, fscio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::key_value_object, fscio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(fscio::chain::index64_object, fscio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::index128_object, fscio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::index256_object, fscio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::index_double_object, fscio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::index_long_double_object, fscio::chain::index_long_double_index)

FC_REFLECT(fscio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(fscio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(fscio::chain::index64_object)
REFLECT_SECONDARY(fscio::chain::index128_object)
REFLECT_SECONDARY(fscio::chain::index256_object)
REFLECT_SECONDARY(fscio::chain::index_double_object)
REFLECT_SECONDARY(fscio::chain::index_long_double_object)
