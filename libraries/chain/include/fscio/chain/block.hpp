#pragma once
#include <fscio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( fscio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(fscio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(fscio::chain::transaction_receipt, (fscio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(fscio::chain::signed_block, (fscio::chain::signed_block_header), (transactions)(block_extensions) )
