...
FC_REFLECT(fscio::chain::block_header, 
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

FC_REFLECT_DERIVED(fscio::chain::signed_block_header, (fscio::chain::block_header), (producer_signature))
FC_REFLECT(fscio::chain::header_confirmation,  (block_id)(producer)(producer_signature) )
