...
CHAINBASE_SET_INDEX_TYPE(fscio::chain::permission_object, fscio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(fscio::chain::permission_usage_object, fscio::chain::permission_usage_index)

FC_REFLECT(fscio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(fscio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(fscio::chain::permission_usage_object, (last_used))
