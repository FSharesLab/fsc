...
public:
   ...
   /*
      ...
      unix:///home/username/fscio-wallet/kfscd.sock/v1/wallet/sign_digest
      for example. When the fc::url is given to http_client in post_sync(), this will
      have proto=unix and host=/home/username/fscio-wallet/kfscd.sock/v1/wallet/sign_digest
      ...
      host=/home/username/fscio-wallet/kfscd.sock and path=/v1/wallet/sign_digest
