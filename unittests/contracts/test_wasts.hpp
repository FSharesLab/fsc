...
(module
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (if (i64.eq (get_local $2) (i64.const 1)) (then
    (call $fscio_assert (i64.eq (get_global $g0) (i64.const 2)) (i32.const 0))
    (return)
  ))
  (call $fscio_assert (i32.const 0) (i32.const 0))
 )
...
(module
 (import "env" "require_auth" (func $require_auth (param i64)))
 (import "env" "fscio_assert" (func $assert (param i32 i32)))
...
"(module"                                                                             \
" (export \"apply\" (func $apply))"                                                   \
" (import \"" FSCIO_INJECTED_MODULE_NAME "\" \"checktime\" (func $inj (param i32)))"  \
" (func $apply (param $0 i64) (param $1 i64) (param $2 i64))"                         \
")";
