...
mkdir -p ${PROJECT}/${VERSION}/opt/fscio/lib/cmake
...
echo "class Fscio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/fscio/fsc/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/fscio/fsc/releases/download/v${VERSION}\"
