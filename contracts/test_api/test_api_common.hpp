...
#ifdef DISABLE_FSCLIB_SERIALIZE
#include <fsciolib/serialize.hpp>
#undef FSCLIB_SERIALIZE
#define FSCLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  FSCLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   FSCLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   FSCLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   FSCLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
