...
void test_crypto::test_recover_key() {
   ...
   for ( uint32_t i=0; i < sizeof(pk); i++ )
      if ( pk.data[i] != sh.pk.data[i] )
         fscio_assert( false, "public key does not match" );
}
...
void test_crypto::test_sha1() {
  ...
  fscio_assert( my_memcmp((void *)test1_ok_1, &tmp, sizeof(checksum160)), "sha1 test1" );

  sha1( (char *)test3, my_strlen(test3), &tmp );
  fscio_assert( my_memcmp((void *)test3_ok_1, &tmp, sizeof(checksum160)), "sha1 test3" );

  sha1( (char *)test4, my_strlen(test4), &tmp );
  fscio_assert( my_memcmp((void *)test4_ok_1, &tmp, sizeof(checksum160)), "sha1 test4" );

  sha1( (char *)test5, my_strlen(test5), &tmp );
  fscio_assert( my_memcmp((void *)test5_ok_1, &tmp, sizeof(checksum160)), "sha1 test5" );
}
...
void test_crypto::test_sha256() {
  ...
  fscio_assert( my_memcmp((void *)test1_ok_256, &tmp, sizeof(checksum256)), "sha256 test1" );

  sha256( (char *)test3, my_strlen(test3), &tmp );
  fscio_assert( my_memcmp((void *)test3_ok_256, &tmp, sizeof(checksum256)), "sha256 test3" );

  sha256( (char *)test4, my_strlen(test4), &tmp );
  fscio_assert( my_memcmp((void *)test4_ok_256, &tmp, sizeof(checksum256)), "sha256 test4" );

  sha256( (char *)test5, my_strlen(test5), &tmp );
  fscio_assert( my_memcmp((void *)test5_ok_256, &tmp, sizeof(checksum256)), "sha256 test5" );
}
...
void test_crypto::test_sha512() {
  ...
  fscio_assert( my_memcmp((void *)test1_ok_512, &tmp, sizeof(checksum512)), "sha512 test1" );

  sha512( (char *)test3, my_strlen(test3), &tmp );
  fscio_assert( my_memcmp((void *)test3_ok_512, &tmp, sizeof(checksum512)), "sha512 test3" );

  sha512( (char *)test4, my_strlen(test4), &tmp );
  fscio_assert( my_memcmp((void *)test4_ok_512, &tmp, sizeof(checksum512)), "sha512 test4" );

  sha512( (char *)test5, my_strlen(test5), &tmp );
  fscio_assert( my_memcmp((void *)test5_ok_512, &tmp, sizeof(checksum512)), "sha512 test5" );
}
...
void test_crypto::test_ripemd160() {
  ...
  fscio_assert( my_memcmp((void *)test1_ok_ripe, &tmp, sizeof(checksum160)), "ripemd160 test1" );

  ripemd160( (char *)test3, my_strlen(test3), &tmp );
  fscio_assert( my_memcmp((void *)test3_ok_ripe, &tmp, sizeof(checksum160)), "ripemd160 test3" );

  ripemd160( (char *)test4, my_strlen(test4), &tmp );
  fscio_assert( my_memcmp((void *)test4_ok_ripe, &tmp, sizeof(checksum160)), "ripemd160 test4" );

  ripemd160( (char *)test5, my_strlen(test5), &tmp );
  fscio_assert( my_memcmp((void *)test5_ok_ripe, &tmp, sizeof(checksum160)), "ripemd160 test5" );
}
...
void test_crypto::sha1_no_data() {
  ...
  fscio_assert( my_memcmp((void *)test2_ok_1, &tmp, sizeof(checksum160)), "sha1 test2" );
}
...
void test_crypto::sha256_no_data() {
  ...
  fscio_assert( my_memcmp((void *)test2_ok_256, &tmp, sizeof(checksum256)), "sha256 test2" );
}
...
void test_crypto::sha512_no_data() {
  ...
  fscio_assert( my_memcmp((void *)test2_ok_512, &tmp, sizeof(checksum512)), "sha512 test2" );
}
...
void test_crypto::ripemd160_no_data() {
  ...
  fscio_assert( my_memcmp((void *)test2_ok_ripe, &tmp, sizeof(checksum160)), "ripemd160 test2" );
}
...
void test_crypto::assert_sha256_false() {
  ...
  fscio_assert(false, "should have failed");
}
