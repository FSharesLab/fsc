#pragma once
#include <fsciolib/core_symbol.hpp>
...
namespace fscio {
   ...
   */
    ...
    * @param str - the string representation of the symbol
    */
   #define S(P,X) ::fscio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      */
      ...
      FSCLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
     ...
     extended_symbol( symbol_name sym = 0, account_name acc = 0 ):symbol_type{sym},contract(acc){}
      ...
      FSCLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
