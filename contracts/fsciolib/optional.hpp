   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { fscio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { fscio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            fscio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return fscio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline fscio::datastream<Stream>& operator>> (fscio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline fscio::datastream<Stream>& operator<< (fscio::datastream<Stream>& ds, const optional& op)
         {
