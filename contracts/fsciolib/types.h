 ...
 * @details FSCIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
 ...
 * @details FSCIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of FSCIO Transaction Id
 * @details Type of FSCIO Transaction Id. It is 256-bit hash
 */
