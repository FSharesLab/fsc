...
namespace fscio {
   ...
   void get_blockchain_parameters(fscio::blockchain_parameters& params) {
      ...
      fscio_assert( size <= sizeof(buf), "buffer is too small" );
   ...
   private:
      ...
      public:
         ...
         {
            fscio_assert(_offset == _heap_size, "malloc_from_freed was designed to only be called after _heap was completely allocated");
