...
struct limit_order {
   ...
   account_name owner;
      ...
      FSCLIB_SERIALIZE( limit_order, (id)(price)(expiration)(owner) )
   };
   ...
   struct test_k256 {
      ...
      FSCLIB_SERIALIZE( test_k256, (id)(val) )
   };
         ...
         static void on(const trigger& act)
         {
            ...
            switch(act.what)
            {
               case 0:
               {
                  ...
                  fscio::multi_index<N(orders), limit_order,
               ...
               case 1: // Test key265 secondary index
               {
                  ...
                  fscio::multi_index<N(test1), test_k256,
               ...
               break;
               default:
                  fscio_assert(0, "Given what code is not supported.");
               break;
            }
         }
   };
...
namespace multi_index_test {
   extern "C" {
      ...
      void apply( uint64_t /* receiver */, uint64_t code, uint64_t action ) {
         require_auth(code);
         fscio_assert(fscio::dispatch<snapshot_test, snapshot_test::trigger>(code, action),
                      "Could not dispatch");
      }
   }
}
